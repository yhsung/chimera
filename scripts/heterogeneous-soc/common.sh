...
# Must match CHIMERA_R52_FREERTOS_IVSHMEM5_SHMEM's size (64 KiB) in
# hw/arm/chimera_r52_freertos_demo.c — ivshmem-flat requires the shmem fd
# size to equal the device's configured shmem-size exactly.
IVSHMEM_CAN_FREERTOS_SIZE="${IVSHMEM_CAN_FREERTOS_SIZE:-65536}"
...
IVSHMEM_BOOTLOG_VECTORS="${IVSHMEM_BOOTLOG_VECTORS:-1}"
